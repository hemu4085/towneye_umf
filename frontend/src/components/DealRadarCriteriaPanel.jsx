...
import { fetchDealRadarConfig } from '../api';
...
export function buildCriteriaPayload(form) {
  const payload = {};
...
export default function DealRadarCriteriaPanel({
  ...
  function handleApply() {
    onApply(buildCriteriaPayload(form));
  }
      ...
      >
        <div>
          ...
          <p className="text-sm text-graytown mt-1">
            Adjust filters and regenerate the town-wide ranked list.
            {matchSummary && (
        ...
        <div className="mt-5 space-y-6 border-t border-gold/20 pt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <NumberField
              ...
              min={limits.min_expansion_room_sqft?.[0]}
              max={limits.min_expansion_room_sqft?.[1]}
            ...
            <NumberField
              ...
              min={limits.min_lot_sqft?.[0]}
              max={limits.min_lot_sqft?.[1]}
