          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl relative overflow-hidden">
            ...
            <div className="flex gap-4">
              <div className="relative flex-1">
                ...
                {showSuggestions && address.length > 0 && (
                  <div className="absolute top-full left-0 w-full mt-2 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-[100] overflow-hidden">
                    ...
                    >
                      <MapPin className="h-4 w-4 mr-3 text-purple-500 opacity-50" />
              ...
              <button 
                ...
                className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-800 disabled:text-gray-500 text-white px-6 py-3 rounded-xl font-medium transition-colors flex items-center shadow-lg shadow-purple-900/20"
              >
                {isGenerating ? (
