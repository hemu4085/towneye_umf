          ...
          <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex space-x-3">
                <button className="flex items-center text-sm text-white bg-emerald-600 hover:bg-emerald-700 px-3 py-1.5 rounded-lg"><FileDown className="h-4 w-4 mr-2" /> Export to Excel</button>
              </div>
            </div>
