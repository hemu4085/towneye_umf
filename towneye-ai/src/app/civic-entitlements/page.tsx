          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl relative overflow-hidden">
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="bg-amber-600 hover:bg-amber-700 disabled:bg-gray-800 disabled:text-gray-500 text-white px-6 py-3 rounded-xl font-medium transition-colors flex items-center shadow-lg shadow-amber-900/20"
              >
